...
public class BiomeSWTaiga extends BiomeBaseShatteredWorld
{
    ...
    private final BiomeSWTaiga.Type type;

    public BiomeSWTaiga(BiomeSWTaiga.Type typeIn, Biome.BiomeProperties properties)
    {
        super(properties);
        this.type = typeIn;
        ...
        if (typeIn != BiomeSWTaiga.Type.MEGA && typeIn != BiomeSWTaiga.Type.MEGA_SPRUCE)
        {
    ...
    {
        if ((this.type == BiomeSWTaiga.Type.MEGA || this.type == BiomeSWTaiga.Type.MEGA_SPRUCE) && rand.nextInt(3) == 0)
        {
            return this.type != BiomeSWTaiga.Type.MEGA_SPRUCE && rand.nextInt(13) != 0 ? MEGA_PINE_GENERATOR : MEGA_SPRUCE_GENERATOR;
        }
        else
        {
    ...
    {
        if ((this.type == BiomeSWTaiga.Type.MEGA || this.type == BiomeSWTaiga.Type.MEGA_SPRUCE) && net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.ROCK))
        {
    ...
    {
        if (this.type == BiomeSWTaiga.Type.MEGA || this.type == BiomeSWTaiga.Type.MEGA_SPRUCE)
        {
