...
public class FlorusTerrainGenerator {
    ...
    private Biome[] biomesForGeneration = {BiomeInit.REFRACTED_FOREST};
    ...
    public void setBiomesForGeneration(Biome[] biomesForGeneration) {
        this.biomesForGeneration = new Biome[] {BiomeInit.REFRACTED_FOREST};
    }
                ...
                for (int height32 = 0; height32 < 32; ++height32) {
                    ...
                    for (int h = 0; h < 8; ++h) {
                        ...
                        for (int x = 0; x < 4; ++x) {
                            ...
                            for (int z = 0; z < 4; ++z) {
                                if (height < 2) {
                                    primer.setBlockState(x4 * 4 + x, height32 * 8 + h, z4 * 4 + z, Blocks.GRASS.getDefaultState());
                                } else if ((d15 += d16) > 0.0D) {
                                    primer.setBlockState(x4 * 4 + x, height32 * 8 + h, z4 * 4 + z, Blocks.DIRT.getDefaultState());
                                }
                            }
    ...
    protected static final IBlockState STONE = ModBlocks.REFRACTEDSTONE_BLOCK.getDefaultState();
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    protected static final IBlockState GRAVEL = Blocks.GRAVEL.getDefaultState();
    protected static final IBlockState RED_SANDSTONE = ModBlocks.REFRACTEDSAND_BLOCK.getDefaultState();
    protected static final IBlockState SANDSTONE = ModBlocks.REFRACTEDSAND_BLOCK.getDefaultState();
    protected static final IBlockState ICE = ModBlocks.REFRACTEDSAND_BLOCK.getDefaultState();
    ...
    public final void generateBiomeTerrain(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal)
    {
        ...
        for (int j1 = 255; j1 >= 0; --j1)
        {
            ...
            else
            {
                ...
                else if (iblockstate2.getBlock() == ModBlocks.REFRACTEDCOBBLESTONE_BLOCK)
                {
                    if (j == -1)
                    {
                        if (k <= 0)
