...
public class WorldGenOakRefracted extends WorldGenAbstractTree{

	public static final IBlockState LOG = ModBlocks.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.OAKR);
	public static final IBlockState LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumType.OAKR);
	
	private final int minHeight;
	
	public WorldGenOakRefracted() 
	{
		super(false);
		this.minHeight = 12;
	}
