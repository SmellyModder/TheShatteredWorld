...
public class GhostramShroom extends BlockBase implements IPlantable, IGrowable{
 ...
 protected static final AxisAlignedBB SHROOM_COLLISION_AABBTWO = new AxisAlignedBB(0.30000001192092896D, 0.0D, 0.30000001192092896D, 0.699999988079071D, 0.4000000059604645D, 0.699999988079071D);
	...
	public GhostramShroom(String name, Material material) {
		super(name, material);
	 ...
	 public boolean generateBigMushroom(World worldIn, BlockPos pos, IBlockState state, Random rand)
	    {
	        ...
	        WorldGenerator worldgenerator = new SWWorldGenBigMushroomDark(ModBlocks.DARK_BROWN_MUSHROOM_BLOCK);

	        if (state == ModBlocks.GHOSTRAM_SHROOM)
	        {
	            worldgenerator = new SWWorldGenBigMushroomDark(ModBlocks.DARK_BROWN_MUSHROOM_BLOCK);
	        }
