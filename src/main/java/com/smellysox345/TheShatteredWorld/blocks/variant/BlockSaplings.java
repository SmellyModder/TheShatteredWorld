...
public class BlockSaplings extends BlockBush implements IGrowable, IMetaName, IHasModel{
    ...
    public BlockSaplings(String name) 
    {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.OAKR).withProperty(STAGE, Integer.valueOf(0)));
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		{
		case OAKR:
			gen = new WorldGenOakRefracted();
			break;
		case BIRCHR:
			gen = new WorldGenBirchRefracted();
			break;
		}
