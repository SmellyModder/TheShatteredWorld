...
public class ModelShadowSpider extends ModelBase {
    ...
    public ModelShadowSpider() {
        ...
        this.FARFAR_BACK_LEFT_LEG.setRotationPoint(4.0F, 15.0F, 2.0F);
        ...
        this.BACK_RIGHT_LEG.setRotationPoint(-4.0F, 15.0F, 0.0F);
        ...
        this.FARFAR_BACK_RIGHT_LEG.setRotationPoint(-4.0F, 15.0F, 2.0F);
        ...
        this.FARBACK_LEFT_LEG.setRotationPoint(4.0F, 15.0F, 1.0F);
        ...
        this.FARBACK_RIGHT_LEG.setRotationPoint(-4.0F, 15.0F, 1.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.HEAD.rotateAngleX = headPitch * 0.000017453292F;
        float f = ((float)Math.PI / 4F);
        this.FRONT_RIGHT_LEG.rotateAngleZ = -((float)Math.PI / 4F);
        this.FRONT_LEFT_LEG.rotateAngleZ = ((float)Math.PI / 4F);
        ...
        this.FARFAR_BACK_RIGHT_LEG.rotateAngleZ = -((float)Math.PI / 4F);
        this.FARFAR_BACK_LEFT_LEG.rotateAngleZ = ((float)Math.PI / 4F);
        float f1 = -0.0F;
        float f2 = 0.3926991F;
        ...
        this.FARBACK_LEFT_LEG.rotateAngleY += -f6;
        ...
        this.FARBACK_LEFT_LEG.rotateAngleZ += -f10;
    }
}
