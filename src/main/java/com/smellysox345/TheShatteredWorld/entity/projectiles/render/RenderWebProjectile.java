...
private final ModelWebProjectile model = new ModelWebProjectile();
	...
	public RenderWebProjectile(RenderManager manager) {
	 ...
	 public void doRender(EntityWebProjectile entity, double x, double y, double z, float entityYaw, float partialTicks)
	    {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityWebProjectile entity) {
		return TEXTURES;
	}
