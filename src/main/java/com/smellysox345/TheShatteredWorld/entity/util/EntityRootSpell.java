...
public class EntityRootSpell extends Entity{
	...
	public EntityRootSpell(World worldIn) {
		super(worldIn);
		this.lifeTicks = 22;
        this.setSize(0.5F, 0.8F);
	}
	
	public EntityRootSpell(World worldIn, double x, double y, double z, float p_i47276_8_, int p_i47276_9_, EntityLivingBase casterIn)
    {
        this(worldIn);
    ...
    private void damage(EntityLivingBase p_190551_1_)
    {
        ...
        if (p_190551_1_.isEntityAlive() && !p_190551_1_.getIsInvulnerable() && p_190551_1_ != entitylivingbase)
        {
            ...
            {
                p_190551_1_.attackEntityFrom(DamageSource.MAGIC, 12.0F);
            }
            else
            {
                ...
                p_190551_1_.attackEntityFrom(DamageSource.causeIndirectMagicDamage(this, entitylivingbase), 12.0F);
            }
        }
    }
