...
public class ItemShieldCrystal extends ItemBase {

	public ItemShieldCrystal(String name) {
		super(name);
		this.maxStackSize = 1;
...
{
    return repair.getItem() == Item.getItemFromBlock(ModBlocks.CRYSTAL_BLOCK) ? true : super.getIsRepairable(toRepair, repair);
}
