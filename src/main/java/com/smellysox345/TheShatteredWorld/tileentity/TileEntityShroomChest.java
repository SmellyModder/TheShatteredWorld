package com.smellysox345.TheShatteredWorld.tileentity;
...
public class TileEntityShroomChest extends TileEntityLockableLoot implements ITickable{
	...
	{
		return this.hasCustomName() ? this.customName : "container.shroom_chest";
	}
	...
	{
		return new ContainerShroomChest(playerInventory, this, playerIn);
	}
	
	@Override
	public String getGuiID() 
	{
		return Reference.MOD_ID + ":shroom_chest";
	}
	...
	public void update()
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerShroomChest)
                {
                    if (((ContainerShroomChest)entityplayer.openContainer).getChestInventory() == this)
                    {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F)
        {
            ...
            this.world.playSound((EntityPlayer)null, d1, (double)pos.getY() + 0.5D, d2, SoundEvents.BLOCK_CHORUS_FLOWER_DEATH, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0F || this.numPlayersUsing > 0 && this.lidAngle < 1.0F)
        {
            ...
            if (this.lidAngle < 0.5F && f2 >= 0.5F)
            {
                ...
                this.world.playSound((EntityPlayer)null, d3, (double)pos.getY() + 0.5D, d0, SoundEvents.BLOCK_CHORUS_FLOWER_GROW, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
            }
